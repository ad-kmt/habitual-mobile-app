...
class ProductCardVerticalSmall extends StatelessWidget {
  const ProductCardVerticalSmall({Key? key, required this.product}) : super(key: key);
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  product.productName,
                  style:
                  AppTextStyles.bodyRegular.copyWith(color: AppColors.textGray_80),
