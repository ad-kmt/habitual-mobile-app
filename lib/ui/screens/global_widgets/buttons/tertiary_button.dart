...
class TertiaryButton extends StatelessWidget {
  ...
  const TertiaryButton({Key? key, required this.text,required this.onClick}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return TextButton(
      style: ButtonStyle(
        ...
        overlayColor: MaterialStateProperty.all<Color>(AppColors.bgWhite),
